...
const productUploadController = async (req: Request, res: Response) => {
    try {
        ...
        if (Array.isArray(req.files)) {
            ...
            const reqBodyProductDetails: productDetails = { product_name: productName, product_type: productType, product_gender_use: productGenderUse, product_price: productPrice, product_quantity: productQuantity, admin_id: adminId, productDescription: productDescription }
